...
ForgeRouter provides built-in support for real-time communication through WebSockets, complete with automatic AsyncAPI documentation generation. WebSockets enable full-duplex communication between client and server, perfect for real-time applications like chat, live updates, and collaborative features.
...
WebSocket support in ForgeRouter provides a robust foundation for building real-time interactive applications while maintaining the same high-quality documentation and type safety as your REST APIs.