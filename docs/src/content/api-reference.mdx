...
Complete API reference for ForgeRouter types, functions, and methods.
...
##### NewRouter() *FastRouter

Creates a new FastRouter instance with default configuration.
...
### RunLoadTest(router *FastRouter, config LoadTestConfig) LoadTestResult
...
This API reference covers the main public interface of ForgeRouter. For implementation details and internal types, refer to the source code documentation.