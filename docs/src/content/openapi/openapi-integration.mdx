...
ForgeRouter automatically generates comprehensive OpenAPI 3.0 documentation from your Go code. No manual YAML files or annotations required - just write your handlers and get production-ready API documentation.
...
ForgeRouter generates OpenAPI schemas directly from your Go types:
...
ForgeRouter automatically documents parameters from your request structs:
...
ForgeRouter automatically documents success responses:
...
ForgeRouter automatically documents standard error responses:
...
ForgeRouter automatically handles complex object references:
...
ForgeRouter provides multiple documentation viewers:
...
OpenAPI integration in ForgeRouter eliminates the need for manual documentation maintenance while ensuring your API docs are always accurate and up-to-date with your code.